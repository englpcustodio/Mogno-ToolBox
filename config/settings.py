...
APP_NAME = "Mogno API Client Application - CEABS"
APP_VERSION = "v1.2"
...
REDIS_PORT = 6379
REDIS_DB_STATUS = 2 # Banco de Dados: Status
REDIS_DB_LAST_POSITION = 4 # Banco de dados para últimas posições/trafego de dados
